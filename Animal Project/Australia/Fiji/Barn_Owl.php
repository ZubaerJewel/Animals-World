<!DOCTYPE html>
<!-- saved from url=(0077)file:///C:/Users/ASUS/Desktop/project/Australia/Fiji/Barn%20Owl/Barn_Owl.html -->
...
<body id="head1">
 ...
 <img src="Barn_Owl.png" width="600" height="250"><br><h2 class="btn btn-warning">[Click here or Image For<b style="color:green"> HOME</b>]</h2></a>
<h1 class="head2"><div style="background-color:black">About Barn Owl:<h1></h1></div>
...
<h1 style="text-align:center;color:red">Information about Barn Owl:</h1>
...
Surprisingly, these common barn owls do not make the hoot sound that can often be heard at night. Instead the owls produce a high-pitched scream and can also hiss in a similar way to a cator snake if the barn owl feels threatened.
...
Female barn owls lay a clutch of up to 7 eggs in the warm months of spring. The female barn owl nests in a hollow tree or rock, and the barn owl eggs usually hatch after about a month. The male barn owl is known to help feed the barn owl chicks and the barn owl chicks are able to flyby the time they are 12 weeks old.
...
White heart-shaped face and large, dark eyes<br>



</h3><h2>Reference:</h2> https://a-z-animals.com/animals/barn-owl/
