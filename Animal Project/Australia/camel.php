<!DOCTYPE html>
<!-- saved from url=(0074)file:///C:/Users/ASUS/Desktop/project/Australia/Australia/Camel/camel.html -->
...
<body id="head1">
 ...
 <img src="camel.jpg" width="620" height="250"><br><h2 class="btn btn-warning">[Click here or Image For<b style="color:green"> HOME</b>]</h2></a>
<h1 class="head2"><div style="background-color:black">About Camel:<h1></h1></div>
...
<style>
 ...
 <p></p></h1><h4 class="head4"> <div style="background-color:lightgreen">

<h1 style="text-align:center;color:red">Information about the Australian Camel:</h1>
<h3>Camel Classification and Evolution:</h3>
...
<h3>Camel Anatomy and Appearance:</h3>
...
<h3>Camel Distribution and Habitat:</h3>
...
<h3>Camel Conservation Status and Life Today:</h3><br>
Today, although the wild Camel population is extinct they are Common as domestic animalsthroughout much of their natural range and further, with estimates ranging as high as 20 million individuals. In the 1800s, the first Camel was imported into Australia to be used to help people get between places in the vast desert. Since then more and more have followed which has to led there now being a strong feral population that is possibly as high as 1 million Camels roaming the deserts of Central Australia.
...
Camel<br>
Other Name(s):
Dromedary Camel, Arabian Camel, One-Humped Camel<br>
...
Habitat:
Arid desert and scrubland<br>

Colour:
Cream, Tan, Brown, Black<br>
Skin Type:
Hair<br>
Size (L):
2.2m - 3.5m (7.25ft - 11.5ft)<br>
Weight:
300kg - 690kg (660lbs - 1,500lbs)<br>
Top Speed:
64kph (40mph)<br>
...
Herbivore<br>
Prey:
Thorny and Salty Plants, Grass, Grain<br>
Predators:
Lions, Leopards, Humans<br>
...
Long, curved neck and large hump<br>
Fun Fact:
Can survive without water for 10 months!<br>
...
<h3>Reference:</h3> https://a-z-animals.com/animals/camel/

</div></h4><p></p></body></html>